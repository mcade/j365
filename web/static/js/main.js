...
var _user$project$Journal$view = function (model) {
	return A2(
		_elm_lang$html$Html$span,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('journal')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
...
var _user$project$Journal$Model = F4(
	function (a, b, c, d) {
...
var _user$project$Components_JournalShow$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], 'URL: ', model.url))
					])),
				A2(
					...
					[
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								model.postedBy,
								A2(_elm_lang$core$Basics_ops['++'], ' On: ', model.postedOn))))
					]))
			]));
};
var _user$project$Components_JournalShow$NoOp = {ctor: 'NoOp'};
